...
\section{A Bayesian model of metaphor interpretation} \label{rsa}
	...
	\paragraph{The semantics}
		...
		The advantage of defining the semantics in this way is that both the prior of $L_0$, shown in (\ref{vect:prior}), and the likelihood, in (\ref{vect:sem}), are Gaussian distributions, which allows for a closed form solution of $L_0$. 
