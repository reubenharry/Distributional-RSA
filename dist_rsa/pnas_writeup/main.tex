...
\section{Experimental Evaluation} \label{exp}
	...
	% \paragraph{Analysis}
		...
		% Using the same mixed-effects model, we further find a significant preference for the $\QLONE$ best adjective over the second best adjective, indicating that TODO
