...
# for i in :
	...
	for item in result:
		...
		for judgment in ["baseline1","baseline2",]:
			previous_score = (metaphor_to_score_count["baseline"][item["metaphor"]][0])
		...
		for judgment in ["l11","l12",]:
			...
			# "l11","l12",]:
			# result["metaphor"] = (metaphor_to_score_count["metaphor"][0]+item[judgment],metaphor_to_score_count["metaphor"][1]+1)
