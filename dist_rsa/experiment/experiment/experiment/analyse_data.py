...
with open('data.csv', 'w', newline='') as csvfile:
	...
	for trial in trials:
		...
		for result in trial:
			...
			if result["val1"]=="equal" or result["val2"]=="equal": continue

			# print(result["comment"])

			w.writerow([result["metaphor"],result["participant"],result["val1"]])
			w.writerow([result["metaphor"],result["participant"],result["val2"]])
print(which)
