...
\section{A Bayesian model of metaphor interpretation} \label{rsa}
	...
	In this second example, when $\QLONE$ hears \emph{shark}, it infers that John is more likely vicious than quick, even when both are equally probable under $P_L$. This is because, had the speaker wanted to communicate John's quickness, \emph{hummingbird} would have been a more informative utterance.
