...
def make_l1_dict(metaphors):
    ...
    for metaphor in metaphors:
        ...
        results = l1_cat_2d_300_best_2(metaphor)
...
"Skin is parchment","The place is a junkyard","The market is a graveyard","Pornography is a cancer",
