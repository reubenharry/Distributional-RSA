...
def l1_cat_1d_exp(metaphor):
    ...
    quds = quds[:50]
    possible_utterances = possible_utterance_nouns[:]+[a for a in list(adjs) if adjs[a] > abstract_threshold and a in vecs]
...
if __name__ == "__main__":
    ...
    l1_cat_1d_exp(("woman","rose"))
    l1_cat_1d_exp(("woman","rose"))
    l1_cat_1d_exp(("bed","heaven"))
    l1_cat_1d_exp(("bed","heaven"))
