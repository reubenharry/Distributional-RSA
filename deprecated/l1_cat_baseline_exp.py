...
#+possible_utterance_nouns[:10]
    ...
    print("RESULTS\n",[(x,np.exp(y),distance_under_projection(real_vecs[subj],real_vecs[pred],target,real_vecs)) for (x,y) in results[:20]])
    print("check")
    return results
...
if __name__ == "__main__":
    ...
    for subj,pred,target,antitarget in metaphors:
        ...
        l1_cat_baseline((subj,pred,target))
