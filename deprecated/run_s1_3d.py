...
pickle.dump(baseline,open("dist_rsa/data/baseline_dict_3d",'wb'))
pickle.dump(l1,open("dist_rsa/data/l1_dict_3d",'wb'))


l1 = pickle.load(open("dist_rsa/data/l1_dict_3d",'rb'))
baseline = pickle.load(open("dist_rsa/data/baseline_dict_3d",'rb'))
